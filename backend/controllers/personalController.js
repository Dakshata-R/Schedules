...
const createPersonalDetails = (req, res) => {
    ...
    let profileImagePath = req.files?.profileImage ? `/uploads/${req.files.profileImage[0].filename}` : null;
    let coverImagePath = req.files?.coverImage ? `/uploads/${req.files.coverImage[0].filename}` : null;
